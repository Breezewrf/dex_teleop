...
# Configure logging to avoid rich library compatibility issues
logging.basicConfig(
    level=logging.INFO,
...
def run_test_TeleVuer():
    ...
    tv = TeleVuer(use_hand_tracking=use_hand_track, 
                  ...
                  img_shape=(480, 1280), 
                  display_fps=30.0,
                  display_mode="pass-through",      # "ego" or "immersive" or "pass-through"
                #   zmq=False,
                #   webrtc=True, 
                #   webrtc_url="https://192.168.252.28:8012/offer"
                  )
